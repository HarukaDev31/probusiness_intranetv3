...
export function useDashboard() {
    ...
    const loadResumen = async () => {
        try {
            const response = await DashboardService.getResumen(filters.value)
            if (response.success) {
    ...
    const loadEvolucionVolumenes = async () => {
        try {
            const response = await DashboardService.getEvolucionTotal(filters.value)
            if (response.success) {
    ...
    const loadFiltrosContenedores = async () => {
        try {
            const response = await DashboardService.getFiltrosContenedores(filters.value)
            if (response.success) {
    ...
    const loadFiltrosVendedores = async () => {
        try {
            const response = await DashboardService.getFiltrosVendedores(filters.value)
            if (response.success) {
                // Agregar opción "Todos" al inicio
    ...
    const updateFilters = (newFilters: Partial<DashboardFilters>) => {
        ...
        if (newFilters.id_vendedor === null) {
