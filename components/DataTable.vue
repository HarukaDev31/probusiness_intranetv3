          ...
          <div class="flex items-center gap-2 relative">
            <div ref="filtersButtonRef">
              <UButton v-if="showFilters" label="Filtros" icon="i-heroicons-funnel"
                variant="outline" @click="showFiltersPanel = !showFiltersPanel" />
            </div>
            <div ref="filtersPanelRef" v-if="showFiltersPanel && showFilters"
              ...
              <div class="flex justify-end mt-4 pt-3 border-t border-gray-200 dark:border-gray-700">
                <UButton label="Cerrar" color="gray" variant="outline" size="sm" @click="showFiltersPanel = false" @click.stop />
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="mt-6 flex items-center justify-between">
      ...
      <div class="flex items-center gap-4">
        <div class="flex items-center gap-2">
          ...
          <USelect :model-value="localItemsPerPage" :items="PAGINATION_OPTIONS" placeholder="10" class="w-20"
