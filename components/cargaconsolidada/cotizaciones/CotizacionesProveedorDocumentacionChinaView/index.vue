        ...
        <div class="grid grid-cols-1 xl:grid-cols-12 gap-6 mt-6">
            ...
            <div class="xl:col-span-4">
                <DocumentacionSection :loading="loadingDocumentacion" :files="documentosChina" :disabled="true"
                    ...
                    @download-file="downloadFile" @delete-file="deleteFileDocumentacion" :show-remove-button="false" />
            </div>
            ...
            <div class="xl:col-span-5">
                <InspeccionSection :loading="loadingInspeccion" :files="inspeccionChina" :disabled="true"
                    ...
                    @file-removed="deleteFileInspeccion" :show-remove-button="false" />
            </div>
...
import type { CotizacionesProveedorDocumentacionChinaViewProps } from './types'
import { ref, onMounted } from 'vue'
import { useCotizacionProveedor } from '~/composables/cargaconsolidada/useCotizacionProveedor'
// Props
const route = useRoute()
const id = Number(route.params.id)
const props = withDefaults(defineProps<CotizacionesProveedorDocumentacionChinaViewProps>(), {
    backBasePath: '/cargaconsolidada/completados'
})
...
// Métodos
const navigateBack = () => {
    navigateTo(`${props.backBasePath}/cotizaciones/proveedor`)
}
...
const saveAll = async () => {
    ...
    try {
        ...
        showSuccess('Éxito', 'Documentación guardada correctamente')
    } catch (error) {
