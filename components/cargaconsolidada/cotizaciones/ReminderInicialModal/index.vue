        ...
        <div class="min-w-0">
          ...
          <div class="relative min-h-[32rem] h-[min(70vh,720px)] rounded-lg border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 overflow-hidden">
            ...
            <iframe
              ...
              title="Vista previa de cotización inicial"
            />
            <p
            ...
            >
              Esta cotización no tiene Excel de cotización inicial.
            </p>
          </div>
...
const { previewReminderInicial } = useReminderInicial()

const preview = ref<ReminderInicialPreview | null>(null)
...
const loadPreview = async () => {
  ...
  try {
    const res = await previewReminderInicial(props.idCotizacion)
