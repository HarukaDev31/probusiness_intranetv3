...
const fechaCierre = shallowRef(new CalendarDate(2022, 1, 10))
const fechaArribo = shallowRef(new CalendarDate(2022, 1, 10))
const fechaEntrega = shallowRef(new CalendarDate(2022, 1, 10))
