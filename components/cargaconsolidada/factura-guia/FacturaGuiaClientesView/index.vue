...
import type { FacturaGuiaClientesViewProps } from './types'
...
const props = withDefaults(defineProps<FacturaGuiaClientesViewProps>(), {
  basePath: '/cargaconsolidada/abiertos'
})
...
const goToFormularioComprobante = () => {
  ...
  const base = `${basePath.value}/factura-guia/formulario-comprobante`
  navigateTo({
    path: `${base}/${id}`,
