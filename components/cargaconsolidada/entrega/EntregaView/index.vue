...
import type { EntregaViewProps } from './types'
...
import DeliveryAccionesModal from '../../../../components/cargaconsolidada/entrega/DeliveryAccionesModal/index.vue'
import DeliveryCobroServiciosModal from '../../../../components/cargaconsolidada/entrega/DeliveryCobroServiciosModal/index.vue'
import DeliveryServiciosCell from '../../../../components/cargaconsolidada/entrega/DeliveryServiciosCell/index.vue'
...
const props = withDefaults(defineProps<EntregaViewProps>(), {
  ...
  { accessorKey: 'pagado', header: 'Pagado', cell: ({ row }) => formatCurrency(row.original.pagado, 'PEN') },
  {
    id: 'adelantos', header: 'Adelantos', cell: ({ row }) => {
      ...
      return !row.original.id_contenedor_pago ? h(PagoGrid as any, {
        ...
        currency: 'PEN',
        numberOfPagos: (currentRole.value === ROLES.COORDINACION || (currentRole.value === ROLES.CONTABILIDAD || currentRole.value === ROLES.ADMINISTRACION)) ? 3 : pagosDetails.length,
