...
import type { EntregaClientesViewProps } from './types'
...
const props = withDefaults(defineProps<EntregaClientesViewProps>(), {
...
const handleBack = () => {
  if (contenedorId) {
    router.push({ path: `${backBasePath.value}/entrega/${contenedorId}`, query: { tab: 'entregas' } })
  } else {
    router.back()
  }
}
