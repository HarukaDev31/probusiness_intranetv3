  ...
  <div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
      <UButton icon="i-heroicons-arrow-left" color="neutral" variant="ghost"
        @click="navigateTo('/verificacion?tab=cursos')">
        Regresar
      </UButton>

      <UButton icon="i-heroicons-lock-closed" color="primary" @click="handleSave">
        Guardar
      </UButton>
    </div>
          ...
          <div class="space-y-2 text-sm">
            ...
            <div class="flex justify-between items-center">
              ...
              <div class="flex items-center space-x-2">
                ...
                <button v-if="pago.voucher_url" @click="openImageModal(pago.voucher_url)"
