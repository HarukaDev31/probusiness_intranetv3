...
- Prospectos y Embarcados (org ≠ 1) comparten headers: CBM China (solo bandera), CBM destino (solo bandera desde `pais_flags`), CBM Pendiente, CBM IMO, Fob, Total ISD, Logística, Impuestos. Sin nombre de país en el label: la bandera basta. La bandera de destino no se hardcodea a Perú: sale de `id_pais` del consolidado.
- Prospectos (org ≠ 1): Nº, Fecha, Contacto, T.Cliente, Volumen, Fob, ISD, Logística, Impuestos, Tarifa, Descuento, Cotización, Estado, Acciones. Sin Qty Item ni Cargos extra.
