...
- **Backend Laravel**: repositorio hermano en `../probusiness_intranetv2_back`
  - Cuando una tarea implique API, modelos, migraciones o lógica de negocio, asume que el backend está ahí.
  - Usa siempre rutas POSIX relativas (`../probusiness_intranetv2_back`) en la documentación interna, no rutas de Windows.
...
Cuando hagas cambios en `../probusiness_intranetv2_back`:
...
- Por defecto, **busca y modifica también** la parte correspondiente en `../probusiness_intranetv2_back`.
- Asegúrate de:
...
- Cualquier tarea donde sea necesario recordar que:
  - El backend está en `../probusiness_intranetv2_back`.
