export const STATUS_BG_CLASSES = {
    ...
    NO_LOADED: 'bg-red-500 text-white dark:bg-red-500 dark:text-white',
    'NO LOADED': 'bg-red-500 text-white dark:bg-red-500 dark:text-white',
    ...
    PAGADO: 'bg-green-500 text-white dark:bg-green-500 dark:text-white',
