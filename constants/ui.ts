export const STATUS_BG_CLASSES = {
    ...
    LOADED: 'bg-green-500 text-white dark:bg-green-500 dark:text-white   ',
    INSPECTION: 'bg-blue-500 text-white dark:bg-blue-500 dark:text-white',
    NO_LOADED: 'text-gray-500 dark:text-white',
    ...
    COBRANDO: 'bg-primary-500 text-white dark:bg-primary-500 dark:text-white',
    PAGADO: 'bg-white-500 text-gray-500 dark:bg-gray-200 dark:text-gray-500',
    SOBREPAGO: 'bg-red-500 text-white dark:bg-red-500 dark:text-white',
    AJUSTADO: 'bg-yellow-500 text-white dark:bg-yellow-500 dark:text-white',
    DOCUMENTACION: 'bg-blue-500 text-white dark:bg-gray-500 dark:text-white',
...
export const CUSTOMIZED_ICONS = {
    ...
    PDF: `
<svg width="30px" height="32px" viewBox="-4 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const CUSTOMIZED_ICONS_URL = {
