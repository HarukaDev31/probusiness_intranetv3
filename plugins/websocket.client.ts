  ...
  setup(nuxtApp) {
    ...
    const initializeWebSockets = async () => {
      ...
      try {
        ...
        // Solo sincronizar salas Soporte TI si estamos en esa sección (evita GET /solicitudes en toda la app).
        if (typeof window !== 'undefined' && window.location.pathname.includes('/soporte-ti')) {
