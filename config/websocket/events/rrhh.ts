...
/**
 * Configuración de eventos para el rol RRHH.
 * Mismos accesos de notificaciones en tiempo real que el Jefe de Ventas (Cotizador).
 */
export const registerRRHHEvents = () => {
